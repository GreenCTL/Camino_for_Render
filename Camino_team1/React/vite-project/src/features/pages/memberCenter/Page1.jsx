...
function P_1_PackageTour() {
  ...
  useEffect(() => {
    fetch("https://camino-for-render-backend2.onrender.com/api/hotspots") // 替換為你的後端 API URL
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://camino-for-render-backend2.onrender.com/api/hotspots/summary") // 替換為你的後端 API URL
      .then((res) => res.json())
      .then((data) => {
