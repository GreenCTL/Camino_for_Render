...
// ---------------------------------------------
// ✅ 設定靜態檔案（dist）目錄
app.use(express.static(path.join(__dirname, 'Camino_team1/React/vite-project/dist')));

// ✅ 所有未命中的路由都回傳 index.html，讓 React Router 處理
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'Camino_team1/React/vite-project/dist', 'index.html'));
});
// ---------------------------------------------
